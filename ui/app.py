...
demo = gr.Interface(
    ...
    outputs=gr.Markdown(),
    title="Pneumonia Detection — Machine Learning Demo",
    description="Upload a chest X-ray image to receive a pneumonia prediction.\n\n"
    "This application is a portfolio project by Daniel Calvo, created for "
